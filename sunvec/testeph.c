...
/*****************************************************************************
*    *****    jpl planetary and lunar ephemerides    *****     C ver.1.6.1   *
******************************************************************************
* program testeph                                                            *
*                                                                            *
*                                                                            *
...
*                    Lunar mantle angular velocity and TT-TDB not handled    *
*                    in this version                                         *
...
*  translated to the C language by Piotr A. Dybczynski (dybol@amu.edu.pl).   *
*                                                                            *
*  This is version 1.6.1 of this C translation, use jplbin.h version 1.6.1   *
*
******************************************************************************
*                 Last modified: June 15, 2024 by PAD                        *
******************************************************************************
...
/* the JPL binary ephemeris files start to be so large that the following line
seems to be necessary in the standard Linux 32-bit environment */
...
/**** YOU PROBABLY HAVE TO ALTERNATE THE FOLLOWING TWO DEFINITIONS: ************/

#define TESTFILE "testpo.441"

#define EPHFILE  "jpleph.441"
...
void interp(double buf[],double t[2],int ncf,int ncm,int na,int ifl,
            double posvel[6]);
...
int main(void)
{
  ...
  int npt=1000;         /* results will be printed to screen every npt lines */

/***** Write a fingerprint to the screen. ***********************************/

  puts("\n JPL test-ephemeris program (v.1.6)\n"
